        ...
        <div>
          <table>
            ...
            <tr>
              ...
              <td>
                <button  className = "numeric" value="7" onClick={handleClick}>
                  7
                </button>
              </td>
              <td>
                <button   className = "numeric" value="8" onClick={handleClick}>
                  8
                </button>
              </td>
              <td>
                <button  className = "numeric" value="9" onClick={handleClick}>
                  9
                </button>
              </td>
              <td>
            ...
            <tr>
              ...
              <td>
                <button   className = "numeric" value="4" onClick={handleClick}>
                  4
                </button>
              </td>
              <td>
                <button  className = "numeric" value="5" onClick={handleClick}>
                  5
                </button>
              </td>
              <td>
                <button  className = "numeric" value="6" onClick={handleClick}>
                  6
                </button>
              </td>
              <td id="yellow">
            ...
            <tr>
              ...
              <td>
                <button  className = "numeric" value="1" onClick={handleClick}>
                  1
                </button>
              </td>
              <td>
                <button  className = "numeric" value="2" onClick={handleClick}>
                  2
                </button>
              </td>
              <td>
                <button  className = "numeric" value="3" onClick={handleClick}>
                  3
                </button>
              </td>
              <td>
            ...
            <tr>
              ...
              <td colSpan="2">
                <button   className = "numeric" value="0" onClick={handleClick}>
                  0
                </button>
              </td>

              <td>
                <button   className = "numeric" value="." onClick={handleClick}>
                  .
                </button>
              </td>
              <td>
